...
|                            | [transactions.update_transactions(budget_id, id, data)](https://github.com/ynab/ynab-sdk-ruby/blob/master/docs/TransactionsApi.md#update_transactions)                                                       | Updates multiple transactions                                 |
