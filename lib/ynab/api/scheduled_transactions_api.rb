...
module YnabApi
  class ScheduledTransactionsApi
    ...
    # @param scheduled_transaction_id ID of scheduled transaction
    # @param [Hash] opts the optional parameters
    # @return [Array<(ScheduledTransactionDetailResponse, Fixnum, Hash)>] ScheduledTransactionDetailResponse data, response status code and response headers
    def get_scheduled_transaction_by_id_with_http_info(budget_id, scheduled_transaction_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ScheduledTransactionDetailResponse')
      if @api_client.config.debugging
    ...
    # @param budget_id ID of budget
    # @param [Hash] opts the optional parameters
    # @return [Array<(ScheduledTransactionSummariesResponse, Fixnum, Hash)>] ScheduledTransactionSummariesResponse data, response status code and response headers
    def get_scheduled_transactions_with_http_info(budget_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ScheduledTransactionSummariesResponse')
      if @api_client.config.debugging
