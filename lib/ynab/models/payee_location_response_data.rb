...
module YNAB
  class PayeeLocationResponseData
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'payee_location')
    ...
    def list_invalid_properties
      ...
      if @payee_location.nil?
        invalid_properties.push('invalid value for "payee_location", payee_location cannot be nil.')
      end
    ...
    def valid?
      return false if @payee_location.nil?
      true
    end
