...
module YNAB
  module Overrides
    class TransactionsApi < YNAB::TransactionsApi
      ...
      # @param plan_id The id of the budget (\&quot;last-used\&quot; can also be used to specify the last used budget)
      # @param data The transaction or transactions to create
      # @param [Hash] opts the optional parameters
      # @return [SaveTransactionsResponse]
      def create_transactions(plan_id, data, opts = {})
      ...
      def bulk_create_transactions(plan_id, transactions, opts = {})
        DeprecatedApi.new(@api_client).bulk_create_transactions(plan_id, transactions, opts)
      end
    end
  end
end
